...
public class OrderCancelAdapter extends RecyclerView.Adapter<OrderCancelAdapter.ViewHolder> implements Constant, Filterable {
    private static List<Order> list;
    private final List<Order> listOld;
    private final Context context;


    public OrderCancelAdapter(Context context, List<Order> list) {
        this.context = context;
        OrderCancelAdapter.list = list;
        this.listOld = list;
    }
